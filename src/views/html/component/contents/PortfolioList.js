...
function PortfolioList({ page = 'work' }) {
    const items = [
        ...
        },
        {
            ...
            titleDetail: ['접근성 한국인터넷 진흥원', ''],

            descDetail: ['접근성 퍼블리싱', '디자이너와 협업'],
        ...
        },
        {
            ...
            titleDetail: ['현대사회와 윤리 교과서', '디지털 교과서 앱 웹뷰'],

            descDetail: ['웹뷰 퍼블리싱', '개발자 협업'],
        ...
        },
        {
            ...
            titleDetail: ['역사 2 교과서', '디지털 교과서 앱 웹뷰'],
        ...
        },
        {
            ...
            titleDetail: ['한국사 2 교과서', '디지털 교과서 앱 웹뷰'],
        ...
        },
        {
            ...
            titleDetail: ['코크플레이 웹/앱', '반응형 리뉴얼 구축'],

            descDetail: ['코크 플레이 앱용 퍼블리싱', 'React 기반의 컴포넌트 퍼블리싱', '디자이너 및 프론트엔드 개발자와 협업'],
